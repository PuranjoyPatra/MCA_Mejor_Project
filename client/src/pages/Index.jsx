    ...
    <>
      ...
      <div className="cm_wrapper">
        <div className="body_text">
          ...
          <p>
            We are happy to help you to engage with your societies and
            their activities
          </p>
      ...
      <div className="info">
        <div className="row">
          <div className="column">
            ...
            <h2>Connect</h2>
            <p>
              There are different societies are available. You can
              connect with them. You can build your network through
              communicating with different kind of people in these
              societies.{' '}
            </p>
          </div>
          <div className="column">
            ...
            <h2>Engage</h2>
            <p>
              Different societies organize different events and
              programs. You can engage with the events and programs by
              involving yourself with participatation.{' '}
            </p>
          </div>
          <div className="column">
            <HearingIcon />
            <h2>Know</h2>
            <p>
              You will get knowledge and improve your skills by
              learning differents things in these societies. You can
              follow your passion through these societies.{' '}
            </p>
          </div>
        </div>
      </div>
