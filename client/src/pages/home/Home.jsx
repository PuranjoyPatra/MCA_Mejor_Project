            ...
            <div className="society_home">
                    ...
                    registeredSocieties.map((registeredSociety) => {
                      return registeredSociety.events.map(
                        (registeredSocietyEvent) => {
                          let joining_text =
                            registeredSocietyEvent.registered_members.includes(
                              context.userId
                            )
                              ? 'Not Going'
                              : 'Going';
              ...
              <div className="statistics_society_area">
                <div className="statistcs_area">
                  <p>
                    There are total {societies.length} societies, you
                    have registered{' '}
                    {registeredSocieties &&
                  ...
                  {societies.map((society) => {
                    ...
                    return (
                      <div className="society" key={society._id}>
                        <div
                          className="society_title"
                          onClick={() => goToDetails(society._id)}
                        >
